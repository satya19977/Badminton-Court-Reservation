  ...
  "Statement": [
    {
      "Effect": "Allow",
      "Principal": {
        "Federated": "arn:aws:iam::616251831149:oidc-provider/oidc.eks.us-east-1.amazonaws.com/id/C9AADAA4AC3BE75D8C40B416A8B38B2A"
      },
      "Action": "sts:AssumeRoleWithWebIdentity",
      "Condition": {
        "StringEquals": {
          "oidc.eks.us-east-1.amazonaws.com/id/C9AADAA4AC3BE75D8C40B416A8B38B2A:aud": "sts.amazonaws.com",
          "oidc.eks.us-east-1.amazonaws.com/id/C9AADAA4AC3BE75D8C40B416A8B38B2A:sub": "system:serviceaccount:kube-system:ebs-csi-controller-sa"
        }
      }
    }
  ]
